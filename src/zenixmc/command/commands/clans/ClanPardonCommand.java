...
public class ClanPardonCommand extends AbstractClanCommand {

	public ClanPardonCommand(ZenixMCInterface zenix, ZenixUserManager manager, OrganizationManager orgManager) {
	...
	public String getDescription() {
		return "Pardons user from clan banlist.";
	}
	...
	public boolean onCommand(ZenixCommandSender sender, String label, String[] args) {
		...
		case 1:
			...
			orgManager.pardonFromClan(sender.zui.getOrganizationPlayer().getClan(), target.getOrganizationPlayer(), sender.zui);
			return true;
		case 2:
			...
			orgManager.pardonFromClan(c, targ.getOrganizationPlayer(), sender.zui);
			return true;
		default:
