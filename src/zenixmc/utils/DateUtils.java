...
public class DateUtils {
    ...
    /**
     * Removes the time pattern from input.
     * @param input
     *      The input string.
    ...
    /**
     * Returns date difference between current time and specified time in a long.
     * @param time
     *      The date to differentiate.
     * @param future
     *      If it should calculate difference into the future/past.
    ...
    public static long parseDateDiff(String time, boolean future) throws IllegalArgumentException {
        ...
        if (!found) {
            throw ExceptionUtils.illegalArgumentException("time is an illegal date.");
        }
     ...
     *      The type of time.
     * @param fromDate
     *      The first date to differentiate.
     * @param toDate
     *      The second date to differentiate.
     * @param future
     *      If it should calculate difference into the future/past.
     * @return The date difference
     */
    ...
    /**
     * Formats the date difference between date and current time into a string.
     * @param date
     *      The date to differentiate.
    ...
    /**
     * Formats the date difference between two dates into a string.
     * @param fromDate
     *      The first date to differentiate.
     * @param toDate
     *      The second date to differentiate.
